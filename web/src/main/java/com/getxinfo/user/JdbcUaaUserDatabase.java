...
public class JdbcUaaUserDatabase implements UaaUserDatabase {
    ...
    public static final String PRE_DEFAULT_USER_BY_EMAIL_AND_ORIGIN_QUERY = "select " + USER_FIELDS + "from users where %s=? and active=? and origin=?";
