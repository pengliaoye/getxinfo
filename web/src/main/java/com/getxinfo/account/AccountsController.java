...
import com.getxinfo.user.UaaAuthority;
...
public class AccountsController {
    ...
    public String verifyUser(Model model,
        ...
        UaaPrincipal uaaPrincipal = new UaaPrincipal(accountCreation.getUserId(), accountCreation.getUsername(), accountCreation.getEmail(), null, null, null);
