...
public class AnnotationsIllustrationTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		final StandardServiceRegistry registry = new StandardServiceRegistryBuilder()
				...
				.build();
		try {
			sessionFactory = new MetadataSources( registry ).getMetadataBuilder()
					.applyIdGenerationTypeInterpreter(new IdGeneratorStrategyInterpreter(){

						@Override
						public String determineGeneratorName(GenerationType generationType,
								GeneratorNameDeterminationContext context) {
							String result = null;
							final Class javaType = context.getIdType();
							if(generationType == GenerationType.AUTO && Long.class.isAssignableFrom(javaType)){
								result = SnowflakeIdGenerator.class.getName();
							}
							return result;
						}
